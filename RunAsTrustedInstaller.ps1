...
if ($confirmation -eq "Y") {
    # Run the file as TrustedInstaller using PsExec with TrustedInstaller context
    Start-Process -FilePath "psexec.exe" -ArgumentList "-accepteula -i -s -d -u TrustedInstaller `"$filePath`"" -NoNewWindow -Wait
} else {
